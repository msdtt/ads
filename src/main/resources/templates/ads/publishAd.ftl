                ...
                <li class="grey">
                    ...
                    <ul class="pull-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
                        ...
                        <li>
                            <a href="#">
                                <div class="clearfix">
                                    <span class="pull-left">Reports generating</span>
                        ...
                        <li>
                            <a href="#">
                                <div class="clearfix">
                                    <span class="pull-left">Advertisment modifying</span>
    ...
    <div class="main-container-inner">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul class="nav nav-list">
                ...
                <li>
                    <a id="adsmanagement" class="dropdown-toggle">
                        <i class="icon-list"></i>
        ...
        <div class="main-content">
            <div class="breadcrumbs" id="breadcrumbs">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">Publish an Ad</li>
                </ul><!-- .breadcrumb -->
